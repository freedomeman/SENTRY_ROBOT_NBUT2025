...
/*------------------------速度环pid-----------------------------*/
// yaw 速度环
#define YAW_SPEED_PID_KP 600.0f//8000       // #define YAW_SPEED_PID_KP 2200.0f//8000
#define YAW_SPEED_PID_KI 0.1f       // #define YAW_SPEED_PID_KI 0.1f
#define YAW_SPEED_PID_KD 6.0f//20       // #define YAW_SPEED_PID_KD 10.0f//20
#define YAW_SPEED_PID_MAX_IOUT 25.0f        // #define YAW_SPEED_PID_MAX_IOUT 25.0f
...
/*------------------------------编码器PID------------------------*/
// yaw轴编码器PID 由编码器角度控制
// #define YAW_ENCODE_PID_KP 20.0f
// #define YAW_ENCODE_PID_KI 0.01f
// #define YAW_ENCODE_PID_KD 200.0f
...
//9025
#define KL_HALF_ECD_RANGE   32768//32768
//电机码盘值一圈的编码值
#define ECD_RANGE 8191
#define LK_ECD_RANGE    65535//65535

//云台中值(中值所对应的编码器编码值)
#define ECD_YAW_MID 49463//0//49113
#define ECD_PITCH_MID 2960

//限幅
#define MAX_GYRO_YAW PI
#define MIN_GYRO_YAW -PI

#define MAX_GYRO_PITCH 0.28f
#define MIN_GYRO_PITCH -0.91f

#define MAX_ENCODE_YAW 1.5*PI
#define MIN_ENCODE_YAW -1.5*PI

#define MAX_ENCODE_PITCH 0.1f//0.29f
#define MIN_ENCODE_PITCH -0.4f//-0.94f

//云台初始化回中值，允许的误差,并且在误差范围内停止一段时间以及最大时间6s后解除初始化状态，
#define GIMBAL_TO_MID_ERROR 1//0.05f
#define GIMBAL_TO_MID_STOP_TIME 200 
#define GIMBAL_TO_MID_TIME 6000
#define GIMBAL_CALI_REDUNDANT_ANGLE 0.1f
// //云台初始化回中值的速度以及控制到的角度
#define GIMBAL_TO_MID_PITCH_SPEED 0.001f 
#define GIMBAL_TO_MID_YAW_SPEED 0.001f   
...
#endif
//9025
#define LK_MOTOR_ECD_TO_RAD 0.000095873799f//0.000095873799f
